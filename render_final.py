...
def motion2smpl(motions, outdir='test_vis', device_id=0, name=None, pred=True):
    ...
    np.save(outdir + name+'_smpl.npy', motion_tensor.cpu().numpy())
...
def render_smpl(motion_tensor, file):
    ...
    imageio.mimsave(file, out, fps=20)
